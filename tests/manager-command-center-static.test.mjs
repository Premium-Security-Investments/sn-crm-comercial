...
const requiredMainMarkers = [
  ...
  'con acción vigente',
  'Ver gestión vigente →',
  "managerAlertRoute('managed')",
  'Pipeline en riesgo',
  'Ver riesgo →',
  "managerAlertRoute('risk')",
  'Ranking por salud comercial',
  'Top 10 oportunidades que requieren decisión',
  'crm-readable-table decision-readable-table',
  'className="client-cell"',
  'className="money-cell numeric-value"',
  'className="next-action-cell"',
  ...
  'manager-kpi-card manager-kpi-active',
  'manager-kpi-card manager-kpi-forecast',
  'manager-kpi-card manager-kpi-risk',
...
const requiredCssMarkers = [
  ...
  '.crm-readable-table .table-actions-cell',
  '.decision-readable-table table',
  '.decision-readable-table th:nth-child(3)',
  '.decision-readable-table td:nth-child(7)',
  '.health-score',
  '.command-priority-title',
  ...
  '.manager-kpi-total',
  '.manager-kpi-active',
  '.manager-kpi-forecast',
  '.manager-kpi-risk',
  '.compact-command-kpis em',
  '.command-action-strip',
