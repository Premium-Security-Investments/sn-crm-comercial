...
assert.match(component, /\{hasIntegralV3 && analysis && analysis\.decision_review && <TenderDecisionBrief/, 'Con decision_review, V3 debe renderizar el panel ejecutivo en lugar de las 20 dudas.');
