...
const expectedOrder = ["['#/dashboard2','Dashboard gerencial']", "['#/alerts','Alertas comerciales']", "['#/opportunities','Oportunidades']", "['#/tenders','Licitaciones']", "['#/vig-ia','Vig-IA']", "['#/new','Crear oportunidad']", "['#/goals','Metas y cumplimiento']"];
let lastIndex = -1;
