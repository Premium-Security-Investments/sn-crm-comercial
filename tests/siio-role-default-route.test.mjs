...
assert.equal(mod.preferredLandingRoute(unauthorized), 'dashboard', 'a profile with no authorized landing route keeps the existing fallback without inventing access');
