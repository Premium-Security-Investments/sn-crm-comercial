...
assert.equal(isModulePermissionEligible('director', 'modulo_siio_gerencial'), false, 'director ya no es elegible para el módulo SIIO gerencial; el scope de F2 vive en backend/board');
