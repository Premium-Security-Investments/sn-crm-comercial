...
for (const [view, component] of [['radar', 'TenderRadarView'], ['seguimiento', 'TenderTrackingView'], ['oportunidades', 'TenderOpportunitiesView'], ['configuracion', 'TenderProfilesView']]) {
