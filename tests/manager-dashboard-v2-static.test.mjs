...
assert.ok(v2FilterMarkup.includes('<input placeholder="Buscar cliente, sede, ciudad o ID…"') && v2FilterMarkup.indexOf('<input placeholder="Buscar cliente, sede, ciudad o ID…"') < v2FilterMarkup.indexOf('empty="Período"') && v2FilterMarkup.indexOf('empty="Período"') < v2FilterMarkup.indexOf('empty="Productos"') && v2FilterMarkup.indexOf('empty="Productos"') < v2FilterMarkup.indexOf('empty="Comerciales"') && v2FilterMarkup.indexOf('empty="Comerciales"') < v2FilterMarkup.indexOf('empty="Regiones"') && v2FilterMarkup.indexOf('empty="Regiones"') < v2FilterMarkup.indexOf('empty="Etapas"') && v2FilterMarkup.indexOf('empty="Etapas"') < v2FilterMarkup.indexOf('empty="Clientes"'), 'Dashboard v2 filter order should be Buscar, Período, Producto/servicio, Comercial, Regional, Etapa, Clientes');
assert.ok(v2FilterMarkup.indexOf('Pipeline activo') > v2FilterMarkup.indexOf('empty="Clientes"') && v2FilterMarkup.indexOf('>Limpiar<') > v2FilterMarkup.indexOf('Pipeline activo'), 'Pipeline activo and Limpiar should remain visible after the primary filters');
