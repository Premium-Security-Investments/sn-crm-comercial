...
assert.deepEqual(labelsFor('gerencia'), ['SIIO Gerencial', 'Dashboard comercial', 'Vig-IA', 'Alertas comerciales', 'Oportunidades', 'Radar de oportunidades', 'Seguimiento', 'Expedientes', 'Perfiles de búsqueda', 'Metas y cumplimiento']);
assert.deepEqual(labelsFor('director'), labelsFor('gerencia'));
assert.deepEqual(labelsFor('admin'), ['SIIO Gerencial', 'Dashboard comercial', 'Vig-IA', 'Alertas comerciales', 'Oportunidades', 'Radar de oportunidades', 'Seguimiento', 'Expedientes', 'Perfiles de búsqueda', 'Metas y cumplimiento', 'Usuarios y permisos']);
