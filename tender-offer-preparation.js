...
export function buildTenderOfferPreparation(opportunity, documents = [], analysis = null, currentProfile = {}) {
  ...
  return {
    ...
    generic_documents, auto_generated_documents, human_required_items, assistant_notes,
    checklist_summary: { total: generic_documents.length + human_required_items.length, auto_generated: auto_generated_documents.length, human_required: human_required_items.length, official_documents: documents.length, has_analysis: !!analysis },
