...
export type SiioRecord = { id: string; front_id: string; title: string; record_type?: string; owner?: string | null; decision_owner?: string | null; status?: string; priority?: string; semaforo?: string; next_action?: string | null; blockers?: string | null; risks?: string | null; decision_required?: string | null; source_ids?: string[]; due_date?: string | null; updated_at?: string | null; created_at?: string | null };
export type SiioDecision = { id: string; item_type: string; description: string; owner?: string | null; due_date?: string | null; status?: string; impact?: string | null; related_record_id?: string | null; updated_at?: string | null; created_at?: string | null };
...
export type SiioTrackingActivityState = 'active' | 'history' | 'unconfirmed';
export type SiioTrackingItem = { id: string; kind: Exclude<SiioTrackingKind, 'todos'>; title: string; owner: string | null; status: string; semaphore: string; nextAction: string | null; frontId: string | null; sourceIds: string[]; dueDate: string | null; activityState: SiioTrackingActivityState };
