...
export type TenderScoreFilter = 'todas' | 'alto' | 'medio' | 'por_validar' | 'bajo';
...
export type TenderOpportunityFilter = 'all' | 'por_decidir' | 'en_curso' | 'cerradas' | 'pending_decision' | 'go_authorized' | 'in_preparation' | 'submitted' | 'closed';
