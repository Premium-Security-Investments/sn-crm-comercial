...
export const SIIO_AGENT_CATALOG: SiioInstitutionalAgent[] = [
  {
    ...
    permitted_actions: ['Leer métricas agregadas', 'Aplicar reglas F5', 'Resumir evidencia', 'Proponer acciones gerenciales'],
    forbidden_actions: ['Aprobar cifras financieras', 'Exponer nómina individual o datos personales', 'Modificar archivos de origen', 'Ejecutar decisiones gerenciales'],
    human_review_required: true,
    can_write_production: false,
  ...
  {
    id: 'AGT-004',
    name: 'Asistente de Junta',
    status: 'diseño',
    owner_role: 'Gerencia General',
    purpose: 'Preparar una salida de Junta a partir del Dashboard permanente, sin convertirse en fuente de verdad.',
    authorized_fronts: ['F2', 'F4', 'F5'],
    authorized_sources: ['SIIO-F2', 'Archivo-F4', 'Lecturas-F5'],
    permitted_actions: ['Seleccionar indicadores validados', 'Ordenar secciones', 'Generar borrador narrativo', 'Marcar revisiones pendientes'],
    forbidden_actions: ['Publicar informes', 'Aprobar cifras', 'Ocultar alertas', 'Sustituir la revisión de Gerencia o Finanzas'],
    human_review_required: true,
    can_write_production: false,
    channel: 'SIIO Gerencial / Modo Junta',
    audit_rule: 'El borrador debe registrar fuentes, periodos, validaciones humanas y secciones modificadas.',
    current_capability: 'Vista y generación de borrador inicial con confirmación; gobierno completo pendiente.',
    next_gate: 'Definir plantilla oficial y responsables de aprobación.',
  },
];
