...
export const SIIO_AGENT_CATALOG: SiioInstitutionalAgent[] = [
  {
    ...
    next_gate: 'Cerrar los hallazgos Important de F2.0 y repetir el QA autenticado por roles.',
  ...
  },
  {
    ...
    human_review_required: true,
    can_write_production: false,
    channel: 'Oportunidades / Mesa de ayuda',
    audit_rule: 'Las acciones sensibles exigen confirmación y deben conservar fuente, usuario y fecha.',
    current_capability: 'Capacidad productiva: análisis canónico pre-GO, GO humano y expediente de oferta; la Mesa de ayuda post-GO queda disponible bajo activación controlada del servidor.',
    next_gate: 'El primer caso real post-GO queda sujeto a la evaluación humana de Juan.',
    state_as_of: '2026-08-22',
    state_source: 'docs/plans/2026-07-29-agt002-vigia-analysis-improvement-program.md + verificación productiva',
    production_capability: 'Análisis canónico pre-GO, GO humano y expediente en producción con revisión humana obligatoria y sin escritura autónoma; la Mesa de ayuda post-GO está disponible bajo activación controlada, no como servicio continuo garantizado.',
    development_status: 'Sin capacidades adicionales promovidas; cualquier ampliación requiere un gate humano aprobado.',
  },
  {
    id: 'AGT-003',
