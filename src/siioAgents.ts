...
export const SIIO_AGENT_CATALOG: SiioInstitutionalAgent[] = [
  ...
  },
  {
    ...
    current_capability: 'Capacidad productiva E5/E6: Radar, análisis documental, perfil corporativo y expediente de oferta, con drain apagado y timer deshabilitado.',
    next_gate: 'Gate humano y canary real pendientes para el contrato integral v3, que permanece en rama sin desplegar y NOT READY.',
