...
export const SIIO_AGENT_CATALOG: SiioInstitutionalAgent[] = [
  ...
  },
  {
    ...
    current_capability: 'Capacidad productiva: análisis canónico pre-GO, GO humano y expediente de oferta; la Mesa Vig-IA Licitaciones post-GO queda disponible bajo activación controlada del servidor.',
    ...
    production_capability: 'Análisis canónico pre-GO, GO humano y expediente en producción con revisión humana obligatoria y sin escritura autónoma; la Mesa Vig-IA Licitaciones post-GO está disponible bajo activación controlada, no como servicio continuo garantizado.',
